(() => {
  ...
  // ns-params:@params
  var baseUrl = "https://crh-ehess.github.io/cartoscope-hugo/";
  ...
  function executeSearch(term) {
    ...
    if (results.length === 0) {
      ...
      searchitems = results.map(function(r) {
        return '<li><a href="' + r.item.permalink + '" tabindex="0"><span class="title">' + r.item.title + "</span></a></li>";
      }).join("");
